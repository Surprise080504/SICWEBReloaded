...
import { getItemsById, getAlmacenById, getOrdenById, getDetailEntradaById } from "src/apis/entradaApi";
...
const NewEntradaPDF: FC<NewEntradaProps> = ({ currentID, saveEntrada, customRef }) => {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} autoComplete="off" ref={customRef}>
        <Box p={1}>
          <Typography
            align="center"
            gutterBottom
            ...
            <Grid container spacing={1}>
              ...
              <Grid item xs={12} sm={6} container alignItems="center" spacing={1}>
                <Grid item xs={12} sm={3}>
                  <TextField id="outlined-basic" InputLabelProps={{ required: false }} required value={ordenData.serie} size="small" fullWidth label="Serie" variant="outlined" />
                </Grid>
                <Grid item>
                  -
                </Grid>
                <Grid item xs={12} sm={6}>
                  <TextField id="outlined-basic" InputLabelProps={{ required: false }} required value={ordenData.numero} size="small" fullWidth label="Número" variant="outlined" />
                </Grid>
              ...
              <Grid item xs={12} sm={6} container alignItems="center">
                <Grid item xs={12}>
                  <TextField id="outlined-basic" InputLabelProps={{ required: false }} required value={ordenData.proveedor} size="small" fullWidth label="Proveedor" variant="outlined" />
                </Grid>
              </Grid>
              <Grid item xs={12} sm={4}>
                <></>
              ...
              <Grid item xs={12} sm={6} container alignItems="center" spacing={1}>
                <Grid item xs={12} sm={3}>
                  <TextField id="outlined-basic" InputLabelProps={{ required: false }} required value={facturaData.serie}
                    ...
                    }} size="small" fullWidth label="Serie" variant="outlined" />
                </Grid>
                <Grid item>
                  -
                </Grid>
                <Grid item xs={12} sm={8}>
                  <TextField id="outlined-basic" InputLabelProps={{ required: false }} required value={facturaData.numero}
                    ...
                    }} size="small" fullWidth label="Número" variant="outlined" />
                </Grid>
              </Grid>
              ...
              <Grid item xs={12} sm={6} container alignItems="center" spacing={1}>
                <Grid item xs={12} sm={9}>
                  <TextField id="outlined-basic" InputLabelProps={{ required: false }} required size="small" fullWidth label="Almacén" variant="outlined" value={almacenData.descripcion} />
                </Grid>
                <Grid item xs={12} sm={3}>
                </Grid>
              </Grid>
              ...
              <Grid item xs={12} sm={10}>
                <ItemTable mode={false} data={items} setData={setItems} />
              </Grid>
